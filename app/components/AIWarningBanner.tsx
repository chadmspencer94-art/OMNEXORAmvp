...
export default function AIWarningBanner({
  ...
  const defaultMessage = "This content has been generated by AI and must be reviewed and verified by you before use. You are responsible for ensuring compliance with all applicable Australian laws and regulations, including but not limited to building codes, safety standards, workplace health and safety requirements, and consumer protection laws.";
