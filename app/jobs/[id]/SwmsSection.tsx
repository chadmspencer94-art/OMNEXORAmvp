...
export default function SwmsSection({
  ...
  const handleDownloadPdf = () => {
    ...
    try {
      ...
      // SWMS CONTENT
      // =========================================
      pdf.addSectionHeading("Safe Work Method Statement");
      
      const sections = parseStructuredContent(textToDownload);
              ...
              <div className="flex-1">
                ...
                {!swmsText && (
                  <p className="text-sm text-red-600 mt-2">
                    Could not generate SWMS right now. Please try again or write your own notes below.
                  </p>
                )}
              </div>
            </div>
